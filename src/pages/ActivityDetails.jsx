...
import StatusDropdown from '../components/StatusDropdown'; // <-- IMPORTED
...
function ActivityDetails() {
  ...
  // NOTE: This function is now mostly redundant but kept in case StatusDropdown needs its colors.
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        {/* Type and Status Badges (Status badge replaced by StatusDropdown) */}
        <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' }}>
          ...
          {/* REPLACED STATIC STATUS BADGE WITH StatusDropdown */}
          <StatusDropdown 
            activityId={id}
            currentStatus={activity.status}
            // onStatusUpdated updates the local state, changing what is displayed
